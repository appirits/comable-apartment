...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'compass-rails', '~> 2.0', '>= 2.0.5'
  spec.add_dependency 'uglifier', '~> 2.7'
  spec.add_dependency 'bootstrap-sass', '~> 3.3', '>= 3.3.3'
  ...
  spec.add_dependency 'jquery-ui-rails', '~> 5.0', '>= 5.0.3'
  spec.add_dependency 'raphael-rails', '~> 2.1', '>= 2.1.2'
  spec.add_dependency 'morrisjs-rails', '~> 0.5', '>= 0.5.1'
  spec.add_dependency 'nprogress-rails', '~> 0.1.6', '>= 0.1.6.7'
  spec.add_dependency 'turbolinks', '~> 2.5', '>= 2.5.3'
  spec.add_dependency 'jquery-turbolinks', '~> 2.1'
  spec.add_dependency 'awesome_admin_layout', '~> 0.2', '>= 0.2.1'
