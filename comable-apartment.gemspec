...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'raphael-rails', '~> 2.1'
  spec.add_dependency 'morrisjs-rails', '~> 0.5'
  spec.add_dependency 'nprogress-rails', '~> 0.1.6'
  spec.add_dependency 'turbolinks', '~> 2.5'
  spec.add_dependency 'jquery-turbolinks', '~> 2.1'
  spec.add_dependency 'awesome_admin_layout', '~> 0.2'
